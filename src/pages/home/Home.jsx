          ...
          <div className="row align-items-center">
            <div className="col-lg-7">
              <h1 className="display-3 fw-bolder hero-heading">
                ...
                you to reach, 
                <TypeAnimation
                  sequence={[" the next level…", 2000, " a better career…", 2000]}
                  wrapper="span"
                  speed={50}
            ...
            <div className="row g-0 align-items-stretch">
              ...
              <div className="col-lg-7 order-lg-first">
                <div className="card-body p-5 d-flex flex-column justify-content-center">
                  ...
                  <p className="card-text">
                    Individuals aspiring for a successful career in Audit & Risk
                    Management, professionals facing technical challenges, and
                    ambitious learners seeking accelerated growth.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="row g-0 align-items-stretch">
              ...
              <div className="col-lg-7">
                <div className="card-body p-5 d-flex flex-column justify-content-center">
                  ...
                  <p className="card-text">
                    We go beyond exam preparation, focusing on strong conceptual
                    clarity that empowers you to reach the next level in your
              ...
              <div className="col-lg-7 order-lg-first">
                <div className="card-body p-5 d-flex flex-column justify-content-center">
                  ...
                  <p className="card-text">
                    ...
                    of recognition that adds real, tangible value to your
            ...
            <div className="row g-0 align-items-stretch">
              ...
              <div className="col-lg-7">
                <div className="card-body p-5 d-flex flex-column justify-content-center">
                  ...
                  <p className="card-text">
                    We offer practical, real-world knowledge and insights that
                    make all the difference, going beyond what can be measured
                    in monetary terms.
                  </p>
                </div>
              </div>
